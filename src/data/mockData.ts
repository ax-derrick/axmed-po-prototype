...
export const paymentTerms: string[] = [
  ...
  'Payment on Delivery',
  'Net 30 on Delivery',
  '40% Upfront Payment/60% Upon Delivery',
  'Net 45 on Delivery',
  '50% Upfront Payment/50% Upon Delivery',
  'Net 60 on Delivery',
  'Net 90 on Delivery',
  '50% Upfront Payment, Balance 30 Days from Delivery',
];
